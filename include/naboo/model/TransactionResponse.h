...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_TransactionResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_TransactionResponse_H_
...
public:
    ...
    /// 
    /// </summary>
    std::vector<utility::string_t>& getMethodOfPayment();
    bool methodOfPaymentIsSet() const;
    void unsetMethod_of_payment();

    void setMethodOfPayment(const std::vector<utility::string_t>& value);
    ...
    /// 
    /// </summary>
    utility::string_t getTransactionStatus() const;
    bool transactionStatusIsSet() const;
    void unsetTransaction_status();

    void setTransactionStatus(const utility::string_t& value);
...
protected:
    ...
    std::vector<utility::string_t> m_Method_of_payment;
    ...
    utility::string_t m_Transaction_status;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_TransactionResponse_H_ */
