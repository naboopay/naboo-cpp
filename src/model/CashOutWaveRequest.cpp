...
void CashOutWaveRequest::validate()
{
    // TODO: implement validation
}

web::json::value CashOutWaveRequest::toJson() const
{
...
bool CashOutWaveRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CashOutWaveRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CashOutWaveRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CashOutWaveRequest::getFullName() const
{
    return m_Full_name;
}

void CashOutWaveRequest::setFullName(const utility::string_t& value)
{
    m_Full_name = value;
    m_Full_nameIsSet = true;
}

bool CashOutWaveRequest::fullNameIsSet() const
{
    return m_Full_nameIsSet;
}

void CashOutWaveRequest::unsetFull_name()
{
    m_Full_nameIsSet = false;
}
int32_t CashOutWaveRequest::getAmount() const
{
    return m_Amount;
}

void CashOutWaveRequest::setAmount(int32_t value)
{
    m_Amount = value;
    m_AmountIsSet = true;
}

bool CashOutWaveRequest::amountIsSet() const
{
    return m_AmountIsSet;
}

void CashOutWaveRequest::unsetAmount()
{
    m_AmountIsSet = false;
}
utility::string_t CashOutWaveRequest::getPhoneNumber() const
{
    return m_Phone_number;
}

void CashOutWaveRequest::setPhoneNumber(const utility::string_t& value)
{
    m_Phone_number = value;
    m_Phone_numberIsSet = true;
}

bool CashOutWaveRequest::phoneNumberIsSet() const
{
    return m_Phone_numberIsSet;
}

void CashOutWaveRequest::unsetPhone_number()
{
    m_Phone_numberIsSet = false;
}
}
